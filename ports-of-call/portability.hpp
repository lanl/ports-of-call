...
#define PORTABLE_CLASS_LAMBDA [&]
#else
#define PORTABLE_CLASS_LAMBDA KOKKOS_CLASS_LAMBDA
#endif // ! __CUDACC__ and ! __HIPCC__
...
#define PORTABLE_CLASS_LAMBDA [=,*this] __host__ __device__
