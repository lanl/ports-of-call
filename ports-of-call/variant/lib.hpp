...
#ifndef _PORTS_OF_CALL_VARIANT_LIB_HPP_
#define _PORTS_OF_CALL_VARIANT_LIB_HPP_
...
#ifdef PORTABLE_HAS_INTEGER_SEQUENCE
...
// <functional>
#ifdef PORTABLE_HAS_TRANSPARENT_OPERATORS
using equal_to = std::equal_to<>;
#else
struct equal_to {
  template <typename Lhs, typename Rhs>
  inline constexpr auto operator()(Lhs &&lhs, Rhs &&rhs) const
      PORTABLE_RETURN(lib::forward<Lhs>(lhs) == lib::forward<Rhs>(rhs))
};
#endif
...
struct Invoke<true /* pmf */, 0 /* is_base_of */> {
  ...
  inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&...args)
      PORTABLE_RETURN((lib::forward<Arg>(arg).*pmf)(lib::forward<Args>(args)...))
};
...
struct Invoke<true /* pmf */, 1 /* is_reference_wrapper */> {
  template <typename R, typename T, typename Arg, typename... Args>
  inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&...args)
      PORTABLE_RETURN((lib::forward<Arg>(arg).get().*pmf)(lib::forward<Args>(args)...))
};
...
struct Invoke<false /* pmo */, 0 /* is_base_of */> {
  ...
  inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
      PORTABLE_RETURN(lib::forward<Arg>(arg).*pmo)
};
...
struct Invoke<false /* pmo */, 1 /* is_reference_wrapper */> {
  template <typename R, typename T, typename Arg>
  inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
      PORTABLE_RETURN(lib::forward<Arg>(arg).get().*pmo)
};
...
template <typename R, typename T, typename Arg, typename... Args>
inline constexpr auto invoke(R T::*f, Arg &&arg, Args &&...args) PORTABLE_RETURN(
...
#pragma warning(disable : 4100)
    ...
    inline constexpr auto invoke(F &&f, Args &&...args)
        PORTABLE_RETURN(lib::forward<F>(f)(lib::forward<Args>(args)...))
#ifdef _MSC_VER
#pragma warning(pop)
#endif
} // namespace detail
...
template <typename F, typename... Args>
inline constexpr auto invoke(F &&f, Args &&...args)
    PORTABLE_RETURN(detail::invoke(lib::forward<F>(f), lib::forward<Args>(args)...))
...
#ifdef PORTABLE_HAS_TRIVIALITY_TYPE_TRAITS
...
#endif // _PORTS_OF_CALL_VARIANT_LIB_HPP_
